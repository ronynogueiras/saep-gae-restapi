...
public class DocumentSeem extends HttpServlet {
...
private ApplicationService application = new ApplicationService();
	 ...
	 * 
	 * @see {http://docs.saep.apiary.io/#reference/0/saepparecerid/get}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		InputStream radocHTML = application.getDocumentHTML();
	 ...
	 * @author Rony Nogueira
	 * @see {http://docs.saep.apiary.io/#reference/0/saepparecerid/post}
	 * @param HttpServletRequest
	 * @param HttpServletResponse
	 * */
	@Override
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		String uuid = request.getPathInfo();
		boolean isCreate = application.createDocument(uuid,report);
		String responseText = "";
		int status;
		if(isCreate){
	...
	/**
	 * Apaga um parecer através do UUID fornecido
	 * @author Rony Nogueira
	 * @see {http://docs.saep.apiary.io/#reference/0/saepparecerid/delete}
	 * @param HttpServletRequest
	 * @param HttpServletResponse
	 * @throws ServletException
	 * @throws IOException
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		String responseText="";
		int status;
		boolean isDelete = application.deleteDocument(uuid);
		if(isDelete){
			status = ContentStatus.NO_CONTENT;
		}else{
			try{
